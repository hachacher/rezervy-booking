...
while($appointment = mysqli_fetch_array($all_appointments)){
	...
	if($rzvy_book_with_datetime == "Y"){
		$event_title = $appointment['title']." ".$label_with." ".$customer_name.$staff_name." ".$label_on." ".date($rzvy_time_format, strtotime($appointment['booking_datetime']))." ".$label_to." ".date($rzvy_time_format, strtotime($appointment['booking_end_datetime']));
	}else{
		$event_title = $appointment['title']." ".$label_with." ".$customer_name.$staff_name;
	}
