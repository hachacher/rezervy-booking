	...
	if(mysqli_num_rows($all_detail)>0){
		while($appt = mysqli_fetch_assoc($all_detail)){	
			...
			if($rzvy_allow_loyalty_points_status=='Y'){
    			$usedpoints = $obj_lpoint->get_used_points_customer_by_order_id($order_id);
			...
			?>
			  ...
			  <div class="row rzvy-mb-5">
				<div class="col-md-3">
					<b><?php if(isset($rzvy_translangArr['loyalty_points'])){ echo $rzvy_translangArr['loyalty_points']; }else{ echo $rzvy_defaultlang['loyalty_points']; } ?></b>
				</div>
				<div class="col-md-9">
