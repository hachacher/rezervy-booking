...
include("config.php");
// Use __DIR__ for reliable path detection across all environments (localhost, Railway, traditional hosting)
define("ROOT_PATH", __DIR__ . '/');
define("BASE_URL", '/');
// Use protocol-relative URLs (//) to automatically match the current page's protocol (http or https)
define("SITE_URL", '//' . $_SERVER['HTTP_HOST'] . '/');
define("AJAX_URL", '//' . $_SERVER['HTTP_HOST'] . '/includes/lib/');
