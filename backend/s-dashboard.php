...
<div class="row mt-4">
	<div class="col-lg-6 col-md-6 col-sm-6 mb-3">
		<div class="card card-stats">
			<div class="card-header card-header-warning card-header-icon text-primary">
				<div class="pull-left">
					<h3 class="mt-1 card-title">
						<small><?php $count_of_total_revenue = $obj_dashboard->get_staff_total_revenue($_SESSION['staff_id']); if($count_of_total_revenue>0){ echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol,$rzvy_currency_position,@number_format($count_of_total_revenue,2)); }else{ echo $obj_settings->rzvy_currency_position($rzvy_currency_symbol,$rzvy_currency_position,"0"); } ?></small>
					</h3>
					<small class="mt-2 card-category mb-1"><?php if(isset($rzvy_translangArr['total_revenue'])){ echo $rzvy_translangArr['total_revenue']; }else{ echo $rzvy_defaultlang['total_revenue']; } ?></small>
				</div>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 mb-3">
		<div class="card card-stats">
			<div class="card-header card-header-warning card-header-icon text-dark">
				<div class="pull-left">
					<h3 class="mt-1 card-title">
						<small><?php echo $obj_dashboard->get_staff_total_appointment($_SESSION['staff_id']); ?></small>
					</h3>
					<small class="mt-2 card-category mb-1"><?php if(isset($rzvy_translangArr['total_appointments'])){ echo $rzvy_translangArr['total_appointments']; }else{ echo $rzvy_defaultlang['total_appointments']; } ?></small>
				</div>
				<div class="pull-right">
