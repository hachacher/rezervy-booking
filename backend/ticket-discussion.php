<?php 
include 'header.php'; 
if(!isset($rzvy_rolepermissions['rzvy_support']) && !isset($rzvy_rolepermissions['rzvy_support_discussion']) && $rzvy_loginutype=='staff'){ ?>
			...
			<div class="rzvy_support_ticket_window">
				...
				if($support_ticket_detail['status'] == "active"){ 
					...
					<div class="rzvy_support_ticket_send_reply_wrapper clearfix">
						...
						<?php if(isset($rzvy_rolepermissions['rzvy_support_reply']) || $rzvy_loginutype=='admin'){ ?>
